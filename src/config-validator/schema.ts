...
export const schema: InputSchema<Config> = {
  ...
  volumeMode: { type: 'string', enum: ['size', 'tick'], optional: true, default: 'size' } as RuleString,
  volumeUnits: { type: 'string', optional: true, default: defaultConfig.volumeUnits } as RuleString,
  ignoreFlats: {
    type: 'boolean',
    optional: true,
